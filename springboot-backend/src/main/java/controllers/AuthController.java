...
public class AuthController {
	...
	public ResponseEntity<?> authenticateUser(@Valid @RequestBody LoginRequest loginRequest){
		...
		SecurityContexHolder.getContext().setAuthentication(authentication);
		String jwt = jwtUtils.generateJwtToken(authentication);
		
		UserDetailsImpl userDetails = (UserDetailImpl) authentication.getPrincipal();
	...
	@PostMapping("/signup")
	public ResponseEntity<?> registerUsr(@Valid @RequestBody SignupRequest signUpRequest){
